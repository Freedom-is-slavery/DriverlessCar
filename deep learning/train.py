...
def train(lr, batch_size, epoches, keep_prob_value):
    ...
    cross_entropy = tf.reduce_mean(-tf.reduce_sum(y_ * tf.log(tf.clip_by_value(y, 1e-15, 1.0)),
            ...
            for i in range(epoches+1):
                ...
                for j in range(iters):
                    ...
                    if j==1:
                        ...
                        # Save model
                        saver_path = saver.save(sess,'D:\\picbase\\test\\model\\model.ckpt')
