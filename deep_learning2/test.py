...
#classes = ['police_go_straight', 'police_slow_down',  'police_stop', 'police_turn_left', 'police_turn_right']
classes = ['forbid_run', 'forbid_turn_around',  'go_straight', 'speed_limit40', 'turn_left', 'turn_right']

def main(args):
    #测试文件位置，可更改
    fold_name = 'D:\\picbase\\test\\capture_mark\\speed_limit40\\img'
    model_dir = 'D:\\picbase\\test\\model_mark\\model.ckpt'
...
def parse_arguments(argv):  
    ...
    parser.add_argument('--model_dir', type=str,  
                        help="model file", default="D:\\picbase\\test\\model_command\\model.ckpt")
